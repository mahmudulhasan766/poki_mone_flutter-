...
class CustomTextFieldState extends State<CustomTextField> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      style: interRegular.copyWith(fontSize:Dimensions.fontSizeDefault,color: widget.isEnabled==false?Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.6):Theme.of(context).textTheme.bodyLarge!.color),
